...
Route::prefix('api_user')->group(function(){
	...
	Route::group(['middleware' =>'auth:api'], function(){
		...
		Route::prefix('user')->group(function(){
			...
			Route::delete('delete','User_appController@delete')->name('user.delete');
		...
		Route::prefix('condominium')->group(function(){
			...
			Route::delete('delete','CondominiumController@delete')->name('condominium.delete');
		});
		...
		Route::prefix('utensil')->group(function(){
			...
			Route::delete('delete','UtensilController@delete')->name('utensil.delete');
			...
			Route::delete('delete_schedule','UtensilScheduleController@delete')->name('utensilSchedule.delete');
		});
		...
		Route::prefix('reserve')->group(function(){
			...
			Route::delete('delete','ReservController@delete')->name('reserve.delete');
